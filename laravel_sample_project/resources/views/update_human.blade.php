...
<div>
    <div class="container">
        <div class="row">
            ...
            <div class="col-sm-6">
                <center><h3>Update Human</h3></center>
                <form class="form" action="{{ url('update')}}" method="post">
                    {{ csrf_field() }}

                     <input hidden type="text" id="id" name="id" value=" {{$human['id']}}">
                    ...
                    @else
                        ...
                        <input type="text" id="fname" name="first_name" value="{{ old('first_name', $human['first_name'])}}">
                    @endif
                    ...
                    @else
                        ...
                        <input  type="text" id="mname" name="middle_name" value="{{ old('middle_name',$human['middle_name'])}}">
                    @endif
                    ...
                    @else
                        ...
                        <input type="text" id="last_name" name="last_name" value="{{ old('last_name',$human['last_name'])}}" >
                    @endif
                    ...
                    @else 
                        ...
                        <input type="password" id="password" name="password" value="{{ old('password',$human['password'])}}" >
                    @endif
                    ...
                    @else 
                        ...
                        <input type="text" id="age" name="age" value="{{ old('age',$human['age'])}}">
                    @endif
                    ...
                    @else 
                        ...
                        &nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="gender" value="2" {{ old('gender', $human->gender == 2) ? 'checked' : '' }}>Female<br>
                    @endif
                    ...
                    @else 
                        ...
                        <input type="text" id="address" name="address" value="{{ old('address',$human['address'])}}">
                    @endif
